    ...
    <section class="bg-primary" id="about">
      <div class="container">
        <div class="row">
          ...
          <br>
          <br>
           <strong><h2 id="greeting" style="color: white; font-size: 45px;">konnect.me</h2></strong>
           <br>
            <h2 class="section-heading text-white">Engineered for college students</h2>
            <hr class="light my-4">
            <p style="font-family: sans-serif; font-size: 18px;" class="text-faded mb-4">A platform that bridges the gap between students from all departments by making social arrangements as quick and as easy as clicking a button.</p>
            <br>
            <a class="btn btn-light btn-xl js-scroll-trigger" href="/create">Get Started</a>
          </div>
        </div>
      </div>
    </section>
